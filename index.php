...
<head>
    ...
    <title>Minto - Simple Finance Tracker</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center gap-3">
                ...
                <li class="nav-item">
                    <a class="btn btn-light text-dark ms-0" href="signup.html">Sign Up</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6 mb-4 mb-md-0">
                <div class="shadow rounded p-3 bg-white">
                    <img src="https://placehold.co/600x400?text=Finance+Dashboard" alt="Minto Dashboard" class="img-fluid rounded">
                </div>
            </div>
...
<section class="cta-section py-5 text-center bg-light">
    <div class="container">
        <div class="cta-wrapper p-5 rounded">
            ...
            <div class="mt-4">
                <a href="signup.html" class="btn btn-light btn-lg px-4 me-md-2">Get Started for Free</a>
