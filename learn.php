...
<head>
    ...
    <title>Minto - Financial Literacy</title>
...
<body>
    ...
    <!-- <section class="content-section">
        <div class="container">
            <h2 class="section-heading">Why Financial Literacy Matters</h2>
            <div class="content-card">
                <ul class="check-list">
                    <li>
                        <i class="bi bi-check-circle-fill"></i>
                        <p>Makes informed financial decisions that align with your long-term goals.</p>
                    </li>
                    <li>
                        <i class="bi bi-check-circle-fill"></i>
                        <p>Reduces financial stress by creating a solid foundation for managing money.</p>
                    </li>
                    <li>
                        <i class="bi bi-check-circle-fill"></i>
                        <p>Builds wealth over time through strategic saving and investing.</p>
                    </li>
                    <li>
                        <i class="bi bi-check-circle-fill"></i>
                        <p>Improves overall financial health and creates a secure future.</p>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="tools-calculators">
                        ...
                        <ul>
                            <li><a href="https://www.bankbazaar.com/emi-calculator/" target="_blank" class="d-flex justify-content-between align-items-center">EMI Calculator <i class="bi bi-arrow-right"></i></a></li>
                            <li><a href="https://www.cleartrip.com/sip-calculator" target="_blank" class="d-flex justify-content-between align-items-center">SIP Planner <i class="bi bi-arrow-right"></i></a></li>
                            <li><a href="https://www.sbi.co.in/web/personal-banking/emicalculator" target="_blank" class="d-flex justify-content-between align-items-center">Loan Calculator <i class="bi bi-arrow-right"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="cta-box">
                ...
                <div class="d-flex justify-content-center flex-wrap">
                    <a href="contact.html" class="btn btn-cta"><i class="bi bi-envelope-fill"></i> Contact Us</a>
                    <a href="resources.html" class="btn btn-cta btn-outline"><i class="bi bi-link"></i> More Resources</a>
                </div>
            </div>
        </div>
    </section>
